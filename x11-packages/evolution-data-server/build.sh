...
termux_step_pre_configure() {
	...
	CFLAGS+=" -I$TERMUX_PREFIX/include/nspr -I$TERMUX_PREFIX/include/nss"
	CXXFLAGS+=" -I$TERMUX_PREFIX/include/nspr -I$TERMUX_PREFIX/include/nss"
	CPPFLAGS+=" -I$TERMUX_PREFIX/include/nspr -I$TERMUX_PREFIX/include/nss"
